        ...
        <div>
            ...
            <div className={css.content}>
                <form className={css.content__main} onSubmit={onSubmit}>
                    ...
                    <input disabled={isUpdatePending} className={css.authForm__input} onInput={onEmailInput} type={'email'}
                           placeholder={'Введите новый e-mail в доменной зоне @urfu.me или @at.urfu.ru'}/>

                    <p className={css.content__text}>Пароль</p>
                    <input disabled={isUpdatePending} className={css.authForm__input} onInput={onPasswordInput} type={'password'}
                           placeholder={'Введите новый пароль'}/>
                    <input disabled={isUpdatePending} className={css.authForm__input} onInput={onPasswordRepetitionInput} type={'password'}
